...
```{r, fig.showtext=TRUE, fig.width = 26.25, fig.height = 22.5}
...
main_plot <- ggplot(data = bond_era_ratings_png) +
  ...
  geom_text(aes(x = middle_point, y = 2.9, label = year_text),
            family = "Mouse", size = 15/.pt) +
  geom_text(aes(x = middle_point, y = mean_bond_rating - 0.155,
                label = surname), family = "Mouse", colour = "#D53129", size = 15/.pt) +
  ...
  theme(legend.position = "none", 
        ...
        axis.text.y = element_text(family = "Mouse", colour = "black", size = 15),
        axis.ticks.x = element_blank(),
        axis.line.x = element_blank(),
        axis.title = element_text(family = "Mouse", size = 20),
        plot.title = element_text(family = "Mouse", size = 25, margin = margin(b = 7.5)),
...
ggplot()+
  ...
  geom_label(data = labels, aes(x = x, y = y, label = text),
                        family = "Mouse", colour = '#D53129', size = 15/.pt) +
  labs(caption = "Data: FiveThirtyEight | Plot: @ldbailey255") +
  theme_void() +
  theme(plot.caption = element_text(family = "Ubuntu Mono", size = 10))
